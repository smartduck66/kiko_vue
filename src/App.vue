...
val_ref_78.push(store.milliers_0.format(Number(station.ensoleillement)) + " h/an");
val_ref_78.push(store.milliers_0.format(Number(station.pluie)) + " mm/an");
val_ref_78.push(store.milliers_0.format(Number(station.vent)) + " j/an");
val_ref_78.push(store.euros_0.format(Number(station.prix_maisons)) + "/m2");
</script>
